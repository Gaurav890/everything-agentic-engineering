...
test("candidate views accept local previews without exposing sources", () => fixture(write => {
  const candidate = {
    ...
    asset_role: "Show the real purchase context beside its financial consequence",
    asset_alternatives: "Considered abstract decoration and charts; photography carries the needed context",
    motion_rationale: "Transitions preserve the relationship between price and monthly impact",
    motion_interruption: "New input reverses the transition immediately without queuing",
