...
import {getProjectBrief, getProjectCandidates, getProjectDesignStatus} from "./project-brief.server";
...
export default async function Page({
  ...
  if (brief && brief.design_mode !== "reference") {
    return <ProjectStudio brief={brief} candidates={getProjectCandidates()} designStatus={getProjectDesignStatus()} />;
  }
