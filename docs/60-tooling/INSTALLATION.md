...
directory and runs `./agentic start`; copy and run it. That same doorway reads
the saved state and routes research, direction, implementation, or proof without
making the newcomer choose an internal command. See
